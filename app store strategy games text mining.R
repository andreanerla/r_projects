...
word_occurrences[word_occurrences =='u0627'] <- '??'
word_occurrences[word_occurrences =='u0644'] <- '??'
...
word_occurrences[word_occurrences =='u0639'] <- '??'
...
bigrams_d_separated[bigrams_d_separated =='u0627'] <- '??'
bigrams_d_separated[bigrams_d_separated =='u0644'] <- '??'
...
bigrams_d_separated[bigrams_d_separated =='u0639'] <- '??'
...
trigrams_d_separated <- descript_trigram %>%
  ...
  filter(!word1 %in% stop_words$word) %>%
  filter(!word2 %in% stop_words$word)
trigrams_d_separated[trigrams_d_separated =='u0627'] <- '??'
trigrams_d_separated[trigrams_d_separated =='u0644'] <- '??'
...
trigrams_d_separated[trigrams_d_separated =='u0639'] <- '??'
trigrams_d_separated[trigrams_d_separated =='u2015'] <- '???'
trigrams_d_separated[trigrams_d_separated =='u0645'] <- '??'
